...
const getReviewableEstimatesController = (0, error_middleware_1.asyncHandler)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const list = estimates.map((estimate) => {
        var _a, _b, _c;
        const profileImage = ((_a = estimate.worker.workProfile) === null || _a === void 0 ? void 0 : _a.profileImage)
            ? `${app_1.BASE_URL}/static/${estimate.worker.workProfile.profileImage}`
            : null;
        return {
            id: estimate.id,
            ...
            nickname: (_c = (_b = estimate.worker) === null || _b === void 0 ? void 0 : _b.workProfile) === null || _c === void 0 ? void 0 : _c.nickname,
            profileImage,
        };
    });
